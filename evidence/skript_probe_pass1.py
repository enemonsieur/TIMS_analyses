...
OUTPUT_DIRECTORY = Path(r"C:\Users\njeuk\OneDrive\Documents\Charite Berlin\TIMS\evidence\skript_probe_pass1_outputs")
...
baseline_window_uv = baseline_cz_uv[window_start_sample : window_start_sample + window_samples]
stim_window_uv = stim_cz_uv[window_start_sample : window_start_sample + window_samples]
print(f"Window check: {CZ_CHANNEL} baseline={baseline_window_uv.shape} stim={stim_window_uv.shape}")


# ===== Fig 1: Continuous view =================================================
time_axis_seconds = np.arange(window_samples, dtype=float) / sfreq
time_axis_seconds += WINDOW_START_S
